    ...
    return Obx(() => Column(
      children: [
        ...
        _buildStatCard(
          ...
          isFullWidth: true,
          onTap: () => dashboardController.showFilteredProductsBottomSheet('total', 'All Products'),
        ),
        ...
        _buildStatCard(
          ...
          isFullWidth: true,
          onTap: () => dashboardController.showFilteredProductsBottomSheet('low_stock', 'Low Stock Products'),
        ),
        SizedBox(height: ResponsiveUtils.getSpacing(context, 16)),
        ...
        _buildStatCard(
          ...
          isFullWidth: true,
          onTap: () => dashboardController.showFilteredProductsBottomSheet('expiring', 'Expiring Soon'),
        ),
        SizedBox(height: ResponsiveUtils.getSpacing(context, 16)),
        ...
        _buildStatCard(
          ...
          isFullWidth: true,
          onTap: () => dashboardController.showFilteredProductsBottomSheet('expired', 'Expired Products'),
        ),
      ],
    ));
  }
